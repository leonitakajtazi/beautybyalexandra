    ...
    <section id="services" className="py-24 bg-brand-blush/30">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center max-w-2xl mx-auto mb-16">
          <h2 className="font-heading text-3xl md:text-4xl text-brand-dark mb-4">Services & Preise</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {SERVICES.map((service: ServiceItem, index) => {
            ...
            return (
              ...
              >
                <div className="w-16 h-16 bg-brand-white rounded-full flex items-center justify-center text-brand-dark mb-6 group-hover:scale-110 transition-transform duration-300 group-hover:bg-brand-dark group-hover:text-white">
                  <Icon size={28} strokeWidth={1.5} />
                </div>
                <h3 className="font-heading font-medium text-xl text-brand-dark mb-3">
                  {service.title}
                </h3>
                ...
                <div className="mt-auto pt-6 border-t border-gray-100 w-full">
                  <span className="font-medium text-lg text-brand-dark">{service.price}</span>
                </div>
              </motion.div>
            );
          })}
